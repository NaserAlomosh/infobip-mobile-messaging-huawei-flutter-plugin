...
void main() {
  ...
  test(
    'global APIs forward values without a Chat controller or view',
    () async {
  ...
  test(
    'method channel sends nullable strings directly and unchanged',
    () async {
      ...
      expect(calls.take(4).map((call) => call.arguments), [
        'Support',
        null,
        '',
        '  Support  ',
      ...
      expect(calls.skip(4).map((call) => call.arguments), [
        'New message',
        null,
        '',
        '  New message  ',
