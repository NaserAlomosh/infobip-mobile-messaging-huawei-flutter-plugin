...
internal object ChannelContract {
    ...
    const val CHAT_EXIT_PRESSED = "exitPressed"
    const val CHAT_WIDGET_THEME_CHANGED = "widgetThemeChanged"
    const val CHAT_WIDGET_INFO_UPDATED = "widgetInfoUpdated"
    const val CHAT_ATTACHMENT_PREVIEW_OPENED = "attachmentPreviewOpened"
    const val CHAT_RAW_MESSAGE_RECEIVED = "rawMessageReceived"
    const val EVENT = "event"
    const val VALUE = "value"
    const val INITIALIZE = "initialize"
    const val CLEANUP = "cleanup"
    const val ENABLE_CALLS = "enableCalls"
    const val ENABLE_CHAT_CALLS = "enableChatCalls"
    const val DISABLE_CALLS = "disableCalls"
    ...
    const val CHAT_EXCEPTION = "chat_exception"
}
